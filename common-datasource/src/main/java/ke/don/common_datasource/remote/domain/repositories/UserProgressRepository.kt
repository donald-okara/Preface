...
interface UserProgressRepository {
    ...
    suspend fun fetchBookProgressByBook(userId: String) : NetworkResult<List<UserProgressResponse>>
    suspend fun updateUserProgress(userProgress: CreateUserProgressDTO)
